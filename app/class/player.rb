class Player
  ...
  def initialize(collector)
    @x = WindowHeight / 2
    @velocity = 0.0
    @image = Gosu::Image.new("./app/assets/images/player.png")
    @sound_collect = Gosu::Sample.new("./app/assets/sound/collect.wav")
    @sound_life_lost = Gosu::Sample.new("./app/assets/sound/life-lost.wav")
    @score = 0
    @lives = 3
  ...
  def max_score?
    self.score >= Level::level_score_total
  end
