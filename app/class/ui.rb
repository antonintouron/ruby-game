class UI
  ...
  def draw_game_over
    @big_font.draw_rel("Game Over", WindowWidth / 2, WindowHeight / 3, ZOrder::UI, 0.5, 0.5, 1, 1, Black)
    @big_font.draw_rel("Press Space To Start", WindowWidth / 2, y + 70, ZOrder::UI, 0.5, 0.5, 1, 1, Black)
  end

  def draw_game_win
    @big_font.draw_rel("Game Win", WindowWidth / 2, WindowHeight / 3, ZOrder::UI, 0.5, 0.5, 1, 1, Black)
    @big_font.draw_rel("Press Space To Replay", WindowWidth / 2, y + 70, ZOrder::UI, 0.5, 0.5, 1, 1, Black)
  end

  def draw_begin_game
    @big_font.draw_rel("Start Game", WindowWidth / 2, WindowHeight / 3, ZOrder::UI, 0.5, 0.5, 1, 1, Black)
    @small_font.draw_rel("You start level 1", WindowWidth / 2, WindowHeight - 400, ZOrder::UI, 0.5, 0.5, 1, 1, Black)
    @small_font.draw_rel("Press H to view the rules in game", WindowWidth / 2, WindowHeight - 370, ZOrder::UI, 0.5, 0.5, 1, 1, Black)
    @small_font.draw_rel("Press space to play", WindowWidth / 2, WindowHeight - 340, ZOrder::UI, 0.5, 0.5, 1, 1, Black)
  end
